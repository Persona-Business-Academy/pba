-- CreateEnum
CREATE TYPE "ApplicantType" AS ENUM ('OFFLINE_COURSE_APPLICANT', 'KIDS_COURSE_APPLICANT', 'CONTACT_US_APPLICANT', 'JOB_APPLICANT', 'ARTICLE_APPLICANT');
...
-- CreateEnum
CREATE TYPE "Topic" AS ENUM ('DESIGN', 'DEVELOPMENT', 'DIGITAL_MARKETING', 'BUSINESS_LAW', 'BUSINESS_ENGLISH', 'MANAGEMENT', 'OTHER');
